...
public class MetroLayout extends ViewGroup {
    ...
    public MetroLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Library_auto_base_metroLayout);
        mDivider = a.getDimensionPixelOffset(R.styleable.Library_auto_base_metroLayout_metro_divider, 0);
