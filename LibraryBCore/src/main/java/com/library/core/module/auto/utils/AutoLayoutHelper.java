...
import com.library.core.module.auto.attr.HeightAttr;
import com.library.core.module.auto.attr.MarginAttr;
import com.library.core.module.auto.attr.MarginBottomAttr;
import com.library.core.module.auto.attr.MarginLeftAttr;
import com.library.core.module.auto.attr.MarginRightAttr;
import com.library.core.module.auto.attr.MarginTopAttr;
import com.library.core.module.auto.attr.MaxHeightAttr;
import com.library.core.module.auto.attr.MaxWidthAttr;
import com.library.core.module.auto.attr.MinHeightAttr;
import com.library.core.module.auto.attr.MinWidthAttr;
import com.library.core.module.auto.attr.PaddingAttr;
import com.library.core.module.auto.attr.PaddingBottomAttr;
import com.library.core.module.auto.attr.PaddingLeftAttr;
import com.library.core.module.auto.attr.PaddingRightAttr;
import com.library.core.module.auto.attr.PaddingTopAttr;
import com.library.core.module.auto.attr.TextSizeAttr;
import com.library.core.module.auto.attr.WidthAttr;
...
public class AutoLayoutHelper {
    ...
    public static AutoLayoutInfo getAutoLayoutInfo(Context context,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Library_AutoLayout);
        int baseWidth = a.getInt(R.styleable.Library_AutoLayout_base_width, 0);
        int baseHeight = a.getInt(R.styleable.Library_AutoLayout_base_height, 0);
        a.recycle();
...
//            if (!isPxVal(val)) continue;
            ...
            if (!AutoUtil.isPxVal(array.peekValue(index))) continue;
